...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-2 mb-3">
            <div class="card">
                <a href="#collapseCardExample" class="card-header text-gray-800" data-toggle="collapse" role="button"
                    aria-expanded="true" aria-controls="collapseCardExample">Kategori</a>
                <div class="collapse show" id="collapseCardExample">
                    <div class="card-body">
                        <div class="d-flex flex-column">
                            @forelse ($category as $c)
                                <a href="{{ url('food/detail/' . $c->id) }}"
                                    class="btn btn-info mb-3">{{ $c->name }}</a>
                            @empty
                                <a href="{{ url('category') }}" class="btn btn-primary mb-3"><i
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="col-lg-4 d-flex flex-column">
                                            <a href="#" class="btn btn-warning btn-sm mb-2"
                                                onclick="editProduct({{ $p->id }})" data-toggle="modal"
                                                data-target="#kategoriEditModal"><i class="fas fa-edit"></i></a>
...
@section('modal-content')
    ...
    <div class="modal fade" id="kategoriEditModal" tabindex="-1" aria-labelledby="kategoriEditModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
