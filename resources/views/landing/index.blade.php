...
<body>
    ...
    <div class="cart">
        ...
        <div class="text-center mt-3">
            <button class="btn btn-danger" style="width: 100%" data-bs-toggle="modal" data-bs-target="#buyModal">Beli
                Sekarang</button>
        </div>
            ...
            <div class="container">
                ...
                <div class="container">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <input class="form-control me-2" style="width: 250px" type="search" id="search-food"
                            onkeyup="searchFood()" placeholder="Cari..." aria-label="Search">
                    </div>
